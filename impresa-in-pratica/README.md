# Impresa in Pratica — scaffold

Prima versione tecnica del nuovo sito "Impresa in Pratica" (guide + corsi + attestati), deciso in `../ANALISI-PROGETTO-GUIDE-FORMAZIONE.md` (§17-19).

**Stato**: bozza statica (HTML/CSS puro, nessuna dipendenza), pensata per essere migrata sul dominio proprio `impresainpratica.it` non appena registrato — vive qui solo perché è l'unico repository disponibile in questa sessione.
...
1. Registrare `impresainpratica.it` e `.com` (§17.3 del documento di analisi).
...
5. Aprire il canale YouTube "Impresa in Pratica" e iniziare la pubblicazione settimanale (§18.3).
