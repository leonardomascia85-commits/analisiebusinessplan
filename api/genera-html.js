...
<style>
  ...
  *{box-sizing:border-box;margin:0;padding:0;}
  ...
  /* MCC */
  .mcc-header{background:#0A1628;color:#fff;border-radius:9px 9px 0 0;padding:14px 18px;}
  .mcc-header-top{font-size:8px;color:rgba(255,255,255,.4);text-transform:uppercase;letter-spacing:.1em;margin-bottom:3px;}
  .mcc-header-title{font-size:16px;font-weight:700;}
  ...
  .mcc-fascia-num{font-size:52px;font-weight:800;line-height:1;}
  ...
  .mcc-scale-num{font-size:18px;font-weight:700;width:24px;text-align:center;}
  ...
  .mcc-score-row div:not(:first-child){text-align:right;}
    ...
    <div>
      ...
      <div style="border:1px solid #E2E8F0;border-radius:8px;overflow:hidden;">
        ${[
          ...
          ['8','Rating MCC','Fondo di Garanzia PMI — Fascia 1–5 · Copertura garanzia'],
...
<div class="page">
  <div class="ph">
    <div><div class="ph-ey">Sezione 8</div><div class="ph-ti">Rating MCC — Fondo di Garanzia PMI</div></div>
    <div class="ph-az">${nome}<br/>${anno}</div>
  </div>
  ...
  <div class="mcc-main">
    ...
    <div class="mcc-scale">
      ...
      <div class="mcc-scale-item${active?' active':''}" style="${active?`border-color:${col};background:${col}0D`:''}">
        <div class="mcc-scale-num" style="color:${active?col:'#CBD5E1'}">${n}</div>
        <div class="mcc-scale-info">
          <div class="mcc-scale-name" style="${active?`color:${col}`:'color:#94A3B8'}">${lbl}</div>
